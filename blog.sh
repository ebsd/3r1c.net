...
index_html() {
	...
	## xxiivv webring
	echo '<a href="https://webring.xxiivv.com/#jurassich" target="_blank" rel="noopener">  <img src="https://webring.xxiivv.com/icon.black.svg" alt="XXIIVV webring" width="55" height="55"/></a>'
	## Fediring
	echo '<p>'
